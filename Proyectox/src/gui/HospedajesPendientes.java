...
public class HospedajesPendientes extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					HospedajesPendientes frame = new HospedajesPendientes();
	 ...
	 * Create the frame.
	 */
	public HospedajesPendientes() {
		setTitle("Hospedajes Pendientes");
		...
		scrollPane.setViewportView(tblPendientes);
		
		JLabel lblTotalAPagar = new JLabel("Total a pagar:");
		lblTotalAPagar.setFont(new Font("Tahoma", Font.PLAIN, 14));
		lblTotalAPagar.setBounds(277, 131, 106, 14);
